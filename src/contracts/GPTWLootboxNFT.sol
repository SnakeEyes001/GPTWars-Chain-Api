...
contract GPTWarsLootboxNFT is ERC721URIStorage, Ownable {
    ...
    function _initializeLootboxes() internal {
        lootboxTypes[0] = Lootbox("Junk Box", 1, 50 * 10**18, "ipfs://QmX4uPF7TSTXpbDwMYVDUwccv8TCvJA5KaYHwZawbxRYSN");
        lootboxTypes[1] = Lootbox("Cheap Box", 2, 150 * 10**18, "ipfs://QmNN7C2BBhHbh3KxqmWAYH8FxUDb1xshHuc5ctpBCyjujm");
        lootboxTypes[2] = Lootbox("Good Box", 3, 300 * 10**18, "ipfs://QmeWKkibVsGUaH8hWk8krMVRb5QoHv2jwbYJGAuaE5zGqU");
        lootboxTypes[3] = Lootbox("Great Box", 4, 500 * 10**18, "ipfs://QmRqNkREaiJsEGLXx1z7gHUmD6DJv2FKUGQqV5rZnLsDc8");
        lootboxTypes[4] = Lootbox("Epic Box", 5, 800 * 10**18, "ipfs://QmUZnJ8bTHFjTCqYWFHEQi6Z5P6TggG1vQLRcTfa1DByfb");
        lootboxTypes[5] = Lootbox("Legendary Box", 6, 1500 * 10**18, "ipfs://QmXGzZu1B2AWxZTv1dXQkGLdxzaTeEAiPfcT4SYvJ5VCdn");
    }
